...
DECODING_TABLE = (
    "\x00"  # 0x0000 -> NULL
    "\u263a"  # 0x0001 -> WHITE SMILING FACE (START OF HEADING)
    "\u263b"  # 0x0002 -> BLACK SMILING FACE (START OF TEXT)
    "\u2665"  # 0x0003 -> BLACK HEART SUIT (END OF TEXT)
    "\u2666"  # 0x0004 -> BLACK DIAMOND SUIT (END OF TRANSMISSION)
    "\u2663"  # 0x0005 -> BLACK CLUB SUIT (ENQUIRY)
    "\u2660"  # 0x0006 -> BLACK SPADE SUIT (ACKNOWLEDGE)
    "\x07"  # 0x0007 -> BELL
    "\x08"  # 0x0008 -> BACKSPACE
    "\t"  # 0x0009 -> HORIZONTAL TABULATION
    "\n"  # 0x000a -> LINE FEED
    "\u2642"  # 0x000b -> MALE SIGN (VERTICAL TABULATION)
    "\u2640"  # 0x000c -> FEMALE SIGN (FORM FEED)
    "\r"  # 0x000d -> CARRIAGE RETURN
    "\u266c"  # 0x000e -> BEAMED SIXTEENTH NOTES (SHIFT OUT)
    "\u263c"  # 0x000f -> WHITE SUN WITH RAYS (SHIFT IN)
    "\u25ba"  # 0x0010 -> BLACK RIGHT-POINTING POINTER (DATA LINK ESCAPE)
    "\u25c4"  # 0x0011 -> BLACK LEFT-POINTING POINTER (DEVICE CONTROL ONE)
    "\u2195"  # 0x0012 -> UP DOWN ARROW (DEVICE CONTROL TWO)
    "\u203c"  # 0x0013 -> DOUBLE EXCLAMATION MARK (DEVICE CONTROL THREE)
    "\u00b6"  # 0x0014 -> PILCROW SIGN (DEVICE CONTROL FOUR)
    "\u00a7"  # 0x0015 -> SECTION SIGN (NEGATIVE ACKNOWLEDGE)
    "\u25ac"  # 0x0016 -> BLACK RECTANGLE (SYNCHRONOUS IDLE)
    "\u21a8"  # 0x0017 -> UP DOWN ARROW WITH BASE (END OF TRANSMISSION BLOCK)
    "\u2191"  # 0x0018 -> UPWARDS ARROW (CANCEL)
    "\u2193"  # 0x0019 -> DOWNWARDS ARROW (END OF MEDIUM)
    "\x1a"  # 0x001a -> SUBSTITUTE (EOF marker)
    "\x1b"  # 0x001b -> ESCAPE
    "\u221f"  # 0x001c -> RIGHT ANGLE (FILE SEPARATOR)
    "\u2194"  # 0x001d -> LEFT RIGHT ARROW (GROUP SEPARATOR)
    "\u25b2"  # 0x001e -> BLACK UP-POINTING TRIANGLE (RECORD SEPARATOR)
    "\u25bc"  # 0x001f -> BLACK DOWN-POINTING TRIANGLE (UNIT SEPARATOR)
    " "  # 0x0020 -> SPACE
